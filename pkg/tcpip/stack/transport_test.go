...
func TestTransportReceive(t *testing.T) {
	...
	buf[0] = 1
	buf[2] = 0
	linkEP.InjectInbound(fakeNetNumber, stack.NewPacketBuffer(&stack.NewPacketBufferOptions{
...
func TestTransportForwarding(t *testing.T) {
	...
	ep2.InjectInbound(fakeNetNumber, stack.NewPacketBuffer(&stack.NewPacketBufferOptions{
