...
func TestWaitWrite(t *testing.T) {
	...
	wep.WritePacket(nil, nil /* gso */, 0, stack.NewPacketBuffer(&stack.NewPacketBufferOptions{}))
...
func TestWaitDispatch(t *testing.T) {
	...
	ep.dispatcher.DeliverNetworkPacket("", "", 0, stack.NewPacketBuffer(&stack.NewPacketBufferOptions{}))
